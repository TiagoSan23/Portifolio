      ...
      <div class="cards">
        <div class="card">
          ...
          <div class="img-wrapper">
            <img
              src="./assets/images/projects/api.gif"
              alt="GIF do projeto Orange Evolution."
            />
            <div class="buttons">
              <a href="https://github.com/API-DSG-1/Projeto-API" target="_blank" title="Repositório no Github">
                <svg
          ...
          <p>
            API- Projeto Integrador de Curso - 1° Semestre.
          </p>
          <p>HTML - CSS - JS - FIGMA - GITHUB</p>
        </div>
        <div class="card">
          <h3>Figma</h3>
          <div class="img-wrapper">
            <img
              src="./assets/images/projects/uber.gif"
          ...
          <p>
            Projeto para clonar pagina de aplicativos ultilizando a ferramenta Figma.
          </p>
          <p>Figma</p>
        </div>
        <div class="card">
